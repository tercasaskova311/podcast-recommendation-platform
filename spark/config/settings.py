...
# User-events (Delta silver table)
DELTA_PATH_DAILY        = os.getenv("DELTA_PATH_DAILY")

# Streaming checkpoint (must be a stable, writable directory)
...
SAFETY_MARGIN = int(os.getenv("SAFETY_MARGIN", "8"))
...
# =============================================================================
# ALS / Recommendations (model artifacts)
# =============================================================================
ALS_MODEL_PATH = os.getenv("ALS_MODEL_PATH")

TOP_N         = int(os.getenv("ALS_TOP_N", "10"))  # top-N recommended podcasts per user
